...
[CustomPropertyDrawer(typeof(BaseUpgrade), true)]
public class BaseUpgradeDrawer : PropertyDrawer
{
    ...
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
    {
        ...
        if (EditorGUI.DropdownButton(typeRect, new GUIContent(displayName ?? "Select Upgrade Type"), FocusType.Keyboard))
        {
    ...
    {
        var baseType = typeof(BaseUpgrade);
